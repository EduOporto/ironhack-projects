...
def calories(service, startDate, endDate, sourceId):
    ...
    calories = [int(e['value'][0]['fpVal']) for e in req['point']]

    return pd.DataFrame({'startTime':start_point, 'endTime':end_point, 'distance_m':calories})